import unittest
from create_and_remove_character import Character, CharacterController  # Replace with the actual module name
...
class TestCharacterController(unittest.TestCase):
    def setUp(self):
        ...
        CharacterController.character_list = []  # Reset character list
        CharacterController.id = 0  # Reset ID counter
    ...
    def test_create_character(self):
        ...
        self.assertIn(character, CharacterController.character_list)
    ...
    def test_remove_character_success(self):
        ...
        self.assertNotIn(character, CharacterController.character_list)
